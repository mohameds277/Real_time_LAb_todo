...
void putchar(char ch)
{
	...
	{
				RC0=1; 
		RC6=0; /* Eabling the Motor A */ 
		RC7=1; /* Eabling the Motor A */ 
...
void motor_settings(int speed  , int direction )
{
	
 		RC0=1; 
		RC6=1; /* Eabling the Motor A */ 
		RC7=0; /* Eabling the Motor A */ 
